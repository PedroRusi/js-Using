    ...
    let frag = {cactus: 'assets/img/el-primo.gif', bullet: 'assets/img/bullets_PNG35556.png'};
    ...
    setInterval(function() {
        ...
        if (num > 0.5) {
            cactus.style.backgroundImage = `url(${frag.cactus})`
            cactus.style.rotate = '0deg' 
        } else {
            cactus.style.backgroundImage = `url(${frag.bullet})`
            cactus.style.rotate = '180deg'
        }
        console.log(num);
        score.innerHTML = `Score: ${i}`
        if (i > 5) {
            document.documentElement.style.background = 'black'
            game[0].style.borderBottom = '1px solid #fff'
    ...
    let isAlive = setInterval(function(){
        ...
        if (cactusLeft < 50 && cactusLeft > -25 && dinoTop >= 150) {
            alert('ВЫ помёрли(')
            i = 0
        }
    }, 10)    
